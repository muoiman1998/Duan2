									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home">											
											...
											<p style="margin-top: 10px; font-style: italic;color: red;">
												<s:property value="%{product.promo1}" />
											</p>
											<p style="margin-top: 10px; font-style: italic;color: red;">
												<s:property value="%{product.promo2}" />
											</p>
											<p style="margin-top: 10px; font-style: italic;color: red;">
												<s:property value="%{product.promo3}" />
											</p>
										...
										<div role="tabpanel" class="tab-pane fade" id="detail">
											...
											<table class="table table-striped">
												<s:iterator value="%{product.proDetails}">
													...
													<tr>
														<td>Màn hình</td>
														<td><s:property value="%{screen}" /></td>
													</tr>
													<tr>
														<td>VGA</td>
														<td><s:property value="%{vga}" /></td>
													</tr>
													<tr>
														<td>Bộ nhớ trong (HDD)</td>
														<td><s:property value="%{storage}" /></td>
													</tr>
													<tr>
														<td>Thẻ nhớ</td>
														<td><s:property value="%{extenMemmory}" /></td>
													</tr>
													<tr>
														<td>Camera sau</td>
														<td><s:property value="%{cam1}" /></td>
													</tr>
													<tr>
														<td>Camera trước</td>
														<td><s:property value="%{cam2}" /></td>
													</tr>
													<tr>
														<td>Sim</td>
														<td><s:property value="%{sim}" /></td>
													</tr>
													<tr>
														<td>Kết nối</td>
														<td><s:property value="%{connect}" /></td>
													</tr>
													<tr>
														<td>Pin</td>
